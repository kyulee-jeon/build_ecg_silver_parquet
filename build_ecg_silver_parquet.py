...
def write_partitioned_batch(out_dir: str, rows: list, schema: pa.Schema, batch_id: int) -> None:
    ...
    Safe Hive-style partitioned write:
      out_dir/modality=ECG/tag=00080020/part-b{batch_id}-{i}.parquet
    - No deletes
...
def parse_args():
    ...
    ap.add_argument("--shard_rows", type=int, default=2_000_000,
                    help="Rows per parquet file within each partition. Default: 200,000 (tune for query performance).")
